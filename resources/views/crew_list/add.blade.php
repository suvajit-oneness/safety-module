    ...
    <div class="card p-md-5 shadow mx-md-5  mt-5">
        ...
        {{-- div for centering the form --}}
            <div class="mx-md-5 " style="">
                <form class="p-md-3 mx-md-5" method="PUT" action="{{ url('crew_list/store') }}" id="crew_list">
                    @csrf
                    ...
                    <div class="tab form-group">
                        ...
                        <select class="form-control" name="Rank" id="Rank">
                            <option disabled selected hidden>Select Rank...</option>
                    ...
                    <div class="tab form-row w-100">
                        ...
                        <div class="col-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="Date_of_birth" name="Date_of_birth" placeholder="Date..." autocomplete="off">
                        </div>
                        {{-- Place Of Borth --}}
                        <div class="col-6 mb-3">
                            <label for="Place_of_birth">Place</label>
                            <input type="text" class="form-control" id="Place_of_birth" name="Place_of_birth" placeholder="Place..." autocomplete="off">
                        </div>
                    </div>
                    ...
                    <div class="tab form-row w-100">
                        ...
                        <div class="col-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="Seaman_Passport_PP_No" name="Seaman_Passport_PP_No" placeholder="PP No...." autocomplete="off">
                        </div>
                        {{-- EXPIRY --}}
                        <div class="col-6 mb-3">
                            <label for="Seaman_Passport_EXPIRY">EXPIRY</label>
                            <input type="text" class="form-control" id="Seaman_Passport_EXPIRY" name="Seaman_Passport_EXPIRY" placeholder="EXPIRY..." autocomplete="off">
                        </div>
                    </div>
                    ...
                    <div class="tab form-row w-100">
                        ...
                        <div class="col-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="Seaman_Book_CDC_No" name="Seaman_Book_CDC_No" placeholder="CDC No...." autocomplete="off">
                        </div>
                        {{-- EXPIRY --}}
                        <div class="col-6 mb-3">
                            <label for="Seaman_Book_EXPIRY">EXPIRY</label>
                            <input type="text" class="form-control" id="Seaman_Book_EXPIRY" name="Seaman_Book_EXPIRY" placeholder="EXPIRY..." autocomplete="off">
                        </div>
                    </div>
                    ...
                    <div class="tab form-row w-100">
                        ...
                        <div class="col-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="Date_Of_Embarkation" name="Date_Of_Embarkation" placeholder="Date Of Embarkation..." autocomplete="off">
                        </div>
                        {{-- Port Of Embarkation --}}
                        <div class="col-6 mb-3">
                            <label for="Port_Of_Embarkation">Port</label>
                            <input type="text" class="form-control" id="Port_Of_Embarkation" name="Port_Of_Embarkation" placeholder="Port Of Embarkation..." autocomplete="off">
                        </div>
                    </div>
