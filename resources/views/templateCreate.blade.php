               ...
               {{-- <input type = "hidden" name = "section_1_id" id="section_1_id" value = "{{$VesselInfoId}}">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <input type="text" class="form-control" id="template_name" placeholder="Enter Template Name" name="template_name">
                    </div>
                </div>
                <div class="row mt-1">
                    <div class="col" >
                        ...
                        <select class="form-control mr-sm-2" id="dept-id" name="dept-id">
                            <option hidden value="">Select Dept Names</option>
...
@section('footer_scripts')
    ...
    <script>
        ...
        var templateData = {!! json_encode(null) !!};
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $('#RiskForm').submit(function() {
                ...
                $('#form_temp').val(formBuilder.actions.getData('json'));

                if($('#form_temp').val()=='null' || $('#form_temp').val()=='[]'){
                    toastr.error('You have not build the form');
                    return false;
                }
            ...
            const formBuilder = $('#createe').formBuilder(options);
        });
    </script>
