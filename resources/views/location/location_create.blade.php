...
<div class="container-fluid">
    <div class="card">
        <div class="card-body">
            ...
            <br>
            <form method="post" action="/location" class="form" id="location_form">
                ...
                <div class="row container">
                    ...
                    <div class="col-9">
                        <input class="form-control" required type="text" name=name id="name" placeholder="Enter Location Name">
                    </div>
                </div>               
