            ...
            <div class="container">
                <div class="card shadow p-3 py-5" style="width:60vw;position: absolute; top:50%; left:50%; transform:translate(-50%,-50%)">
                    ...
                    <div class="mx-md-5 " style="">
                        <form class="p-md-3 mx-md-5" method="POST" action="{{ url('company/store') }}" id="company_form"  enctype="multipart/form-data">
                            @csrf
                            <div class=" form-group">
                                ...
                                <input type="text"   class="form-control" id="Adress" name="Adress" placeholder="Adress..." autocomplete="off">
