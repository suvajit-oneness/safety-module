...
<div class="p-5 text-dark">
        ...
        <div class="my-5">
            ...
            <h6>Preventive Action Note : </h6> <br>
            <p>{{ $nmr->preventive_actions_note }}</p>
            ...
            {{-- Office Coment --}}
            <div class="my-5">
                <span class="font-weight-bold">Office Comments : </span> {{ $nmr->office_comments }}
            </div>


            {{-- Lesson Learnt --}}
            <div class="my-5">
                <span class="font-weight-bold">Lesson Learnt : </span> {{ $nmr->lession_learnt }}
            </div>
