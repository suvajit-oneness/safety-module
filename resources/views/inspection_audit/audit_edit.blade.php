...
@section('content')
    ...
    <div class="container">
        <div class=" ">
            <div class="card shadow p-3 py-5" id="slide_div">
                <!-- Html
                             ================== -->
                <div class="mx-md-5 ">
                    <form class="p-md-3 mx-md-5" id="inspection-and-audit-form" method="post"
                        action="{{ url('/inspection-audit/store') }}" id="audit_Form" enctype="multipart/form-data"
                        files="true">
                        @csrf
                        ...
                        <div class="tab form-group">
                            ...
                            <div class="form-row">
                                <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-6" id="non_confirmity_id">
                                    <button type="button" class="btn btn-outline-success btn-block nc-trick"
                                        data-toggle="modal" data-target="#nomConfirmityModal">
                            ...
                            <div class="d-flex">
                                <button class="btn btn-info mt-5 w-25 mr-auto" type="button" id="prevBtn"
                                    onclick="nextPrev(-1)">Previous</button>
                                <button class="btn btn-info mt-5 w-25 ml-auto" type="button"
                                    id="btn-inspection-and-audit-submit" onclick="form_submit()">Submit Report</button>
                            </div>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-row mt-1">
                                                ...
                                                <textarea class="form-control" id="nc_description" name='description_nc' rows="3"></textarea>
                                            </div>

                                            <div class="form-row mt-1">
                                                <label for="nc_ism_clause">ISM Clause or Other Ref</label>
                                                <textarea class="form-control" id="nc_ism_clause" name="ism_clause_nc" rows="2"></textarea>
                                            </div>
                                            ...
                                            <div class="form-row mt-1" id='corrective_action_increase_NC'>
                                                ...
                                                <div class="input-group">
                                                    <textarea class="form-control mr-2 mb-2" id="nc_corrective_action_1" name="nc_corrective_action[]" rows="2"></textarea>
                                            ...
                                            <div class="form-row mt-1 mb-2">
                                                ...
                                                <textarea class="form-control" id="nc_comments" name="nc_comments" rows="2"></textarea>
                                            </div>
                                    ...
                                    <div class="modal-body">
                                       ...
                                       ================================ --}}
                                            ...
                                            <div class="form-row mt-1" id='corrective_action_increase_OBSERVATION'>
                                                <label for="nc_corrective_action">Corrective Action/s</label>
                                                <div class="input-group">
                                                    <textarea class="form-control mr-2 mb-2" id="nc_OBSERVATION_1" name="obs_corrective_action[]" rows="2"></textarea>
                                                    <button type="button" class="btn btn-primary ml-1 mb-2"
                                                        id='corrective_increasetext_OBSERVATION'
                                                        onclick="addmoreCA()">Add</button>
                                                </div>
                                            </div>
                                            <div class="corrective_actions_prefill"></div>
                                            <div class="form-row mt-1">
                        ...
                        <div class="modal fade" id="pscModal">
                            <div class="modal-dialog modal-xl">
                                <div class="modal-content p-5">
                                    ...
                                    <div class="modal-body">
                                        <div class="form-group">
                                            ...
                                            <div class="form-row mt-1" id="corrective_action_increase_PSC">
                                                <label for="nc_corrective_action">Corrective Action/s</label>
                                                <div class="input-group">
                                                    <textarea class="form-control mr-2 mb-2" id="nc_OBSERVATION_1" name="psc_corrective_action[]" rows="2"></textarea>
                                                    <button type="button" class="btn btn-primary ml-1 mb-2"
                                                        ...
                                                        <div class=" " style="width: 100%;">
                                                            ...
                                                            <div class="form-group col-12 my-3">
                                                                <div class="input-group mb-3">
                                                                    <div class="input-group-prepend">
                                                                        <label class="input-group-text"
                                                                            for="inputGroupSelect01">
                                                                            {{ $dd->dropdown_name }} </label>
                                                                    </div>
                                                                    <select id="psc_{{ Str::lower($name) }}" required
                                                                        class="custom-select drop"
                                                                        myid="psc_dd{{ $dd->id }}" required multiple>
                                                                        @if (Str::lower($name) == 'incidenttype' || Str::lower($name) == 'immediatecause')
                                                                            <option value=0 disabled selected>None Selected
                                                                            </option>
                                                                        @endif
                                                            ...
                                                            <div class="pl-4 form-group col-12 my-3"
                                                                ...
                                                                <div class="pl-3 input-group mb-3">
                                                                    <div class="input-group-prepend">
                                                                        <label class="input-group-text"
                                                                            for="inputGroupSelect01">Options
                                                                        </label>
                                                                    </div>
                                                                    <select
                                                                        @if (Str::lower($name) == 'rootcauses' || Str::lower($name) == 'preventiveactions') multiple @endif
                                            ...
                                            <div class="form-row mt-1">
                                                <div class="form-group col-md-4 col-lg-4 col-sm-4 col-xs-4">
                                                    ...
                                                    <input type="text" class="form-control "
                                                        ...
                                                        id="preventive_action_complete_date_psc"
                                                        placeholder="Enter date...">
                                                </div>
                                                <div class="form-group col-md-4 col-lg-4 col-sm-4 col-xs-4">
                                                    <label for="preventive_action_evidence_psc">Upload Evidence</label>
                                                    <input multiple type="file" class="form-control"
                                                        name="preventive_action_evidence_psc"
                                                        id="preventive_action_evidence_psc">
                                                    <div class="preventive_evidence"></div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="modal-footer" style="justify-content: center!important;">
                                        <button type="button" class="btn btn-primary" data-dismiss="modal"
                                            id='psc-increaserow' value='PSC'>Ok</button>
                                        <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
                                    </div>
                                </div>
                            </div>
        ...
        ============================== -->
                ...
                <!-- Modal -->
                <div class="modal fade" id="CONTINUE_MODAL" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-content">
                            <div class="modal-body text-center p-5">
                                ...
                                <div class='text-center p-3'>
                                    <button type="button" class="btn btn-success shadow mx-3 my-3"
                                        data-dismiss="modal">Yes, Continue
                                        With Draft </button>
                                    <a href="/inspection-audit/Draft" class="btn btn-primary shadow mx-3 my-3">No, Create a
                                        New
                                        Form</a>
                                </div>
                            </div>
...
<script src="{{ asset('js/babel/babel.js') }}"></script>
    ...
    <script src="{{ asset('js/bootstrap_multi_select/bootstrap-multiselect.js') }}"></script>
        ...
        {{-- 🌵 Script to fire sub-form delete on change 🌵
        ======================================================== --}}
        <script>
            // Delete sub-fomrs on change of type of audit .....
            $(()=>{
                $("#type_of_audit").change(function(){
                    let form_type = $("#type_of_audit").val();
                    $.ajax({
                        headers: {
                            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
                    url: "/api/delete-sub-forms-on-input-change",
                    method: "POST",
                    data: {form_type:form_type, master_id : master_id },
                });
            })
        })
    </script>
    ...
    <script>
        $(() => {
            @if (Session::has('audit_new_draft_clicked'))
                // console.log('New Draft Created')
                @php
                    Session::forget('audit_new_draft_clicked');
                @endphp
            @else
                $('#modal_lunch').click()
            @endif
...
<script src="{{ asset('js/custom/audit/prefillSubForms.js') }}"></script>
