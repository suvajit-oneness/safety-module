   ...
   <!--     <select class="form-control mr-sm-2" id="assess-rank" name="assess-rank">
    ...
    <div class="col">
        ...
        @if(isset($risk_assessment_data->vessel_name) && $risk_assessment_data->vessel_name)
          <input type="text" class="form-control mr-sm-2" id="vessel-name" placeholder="Enter Vessel Name" name="vessel-name" value="{{$risk_assessment_data->vessel_name}}">
        @else
            <input type="text" class="form-control mr-sm-2" id="vessel-name" placeholder="Enter Vessel Name" name="vessel-name">
        @endif
    </div>
</div> -->--}}
<div class="row mt-1">
