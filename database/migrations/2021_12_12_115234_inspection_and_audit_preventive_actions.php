...
class InspectionAndAuditPreventiveActions extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('inspection_and_audit_preventive_actions', function(Blueprint $t){
            $t->string('id');
    ...
    {
        Schema::drop('inspection_and_audit_preventive_actions');         
    }
}
