...
class InspectionAndAuditRootCauses extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('inspection_and_audit_root_causes', function(Blueprint $t){
            $t->string('id');
    ...
    {
        Schema::drop('inspection_and_audit_root_causes');
